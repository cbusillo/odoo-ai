...
class DeliveryCarrierServiceMap(models.Model):
    ...
    external_id = fields.Char(
        help="Platform-specific service identifier stored as mapping metadata for this service-map row. It is not treated as the canonical external identity of the delivery.carrier record itself.",
    )
