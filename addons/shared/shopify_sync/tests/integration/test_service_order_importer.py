...
class TestOrderImporter(IntegrationTestCase):
    def setUp(self) -> None:
        ...
        self.product_a.set_external_id("shopify", "987654321", resource="variant")
        ...
        self.product_b.set_external_id("shopify", "987654322", resource="variant")
    ...
    def _import_order_and_verify_success(self, shopify_order: OrderFields) -> "odoo.model.sale_order":
        ...
        order = self.env["sale.order"].search_by_bound_external_id(shopify_id)
    ...
    def test_import_order_basic(self, mock_import_customer: common.MagicMock) -> None:
        ...
        order = self.env["sale.order"].search_by_bound_external_id("111")
        self.assertTrue(order)
    ...
    def test_import_order_with_discounts(self, mock_import_customer: common.MagicMock) -> None:
        ...
        order = self.env["sale.order"].search_by_bound_external_id("123456789")
        self.assertTrue(order)
    ...
    def test_import_order_update_existing(self, mock_import_customer: common.MagicMock) -> None:
        ...
        existing_order.external_reference.id = "111"

        existing_line = self.env["sale.order.line"].create(
            {
        ...
        existing_line.external_reference.id = "1"
...
eBay Order Id:   11-22222-33333   """
    ...
    def test_import_order_with_extreme_values(self, mock_import_customer: common.MagicMock) -> None:
        ...
        order = self.env["sale.order"].search_by_bound_external_id("999999999999999")
        self.assertTrue(order)
    ...
    def test_ebay_order_includes_ebay_info_in_shopify_note(self, mock_import_customer: common.MagicMock) -> None:
        ...
        self.assertEqual(order.external.ebay.order.id, "67890")
