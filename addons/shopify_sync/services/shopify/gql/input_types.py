...
class CollectionDuplicateInput(BaseModel):
    ...
    copy_publications: Optional[bool] = Field(alias="copyPublications", default=True)
...
class CustomShippingPackageInput(BaseModel):
    ...
    name: Optional[str] = None
    type_: Optional[ShippingPackageType] = Field(alias="type", default=None)
...
class DeliveryCustomizationInput(BaseModel):
    function_handle: Optional[str] = Field(alias="functionHandle", default=None)
    title: Optional[str] = None
...
class DiscountAutomaticAppInput(BaseModel):
    ...
    context: Optional["DiscountContextInput"] = None
    function_handle: Optional[str] = Field(alias="functionHandle", default=None)
    metafields: Optional[list["MetafieldInput"]] = Field(default_factory=lambda: [])
...
class DiscountContextInput(BaseModel):
    all: Optional[DiscountBuyerSelection] = None
...
class ExchangeLineItemRemoveFromReturnInput(BaseModel):
    exchange_line_item_id: str = Field(alias="exchangeLineItemId")
    quantity: int
...
class MarketingEngagementInput(BaseModel):
    ...
    primary_conversions: Optional[Decimal] = Field(
        alias="primaryConversions", default=None
    )
    all_conversions: Optional[Decimal] = Field(alias="allConversions", default=None)


class MenuItemCreateInput(BaseModel):
    title: str
    type_: MenuItemType = Field(alias="type")
...
class OnlineStoreThemeFileBodyInput(BaseModel):
    type_: OnlineStoreThemeFileBodyInputType = Field(alias="type")
    value: str
...
class PriceListAdjustmentInput(BaseModel):
    value: float
    type_: PriceListAdjustmentType = Field(alias="type")
...
class ProductBundleConsolidatedOptionComponentInput(BaseModel):
    component_option_value: str = Field(alias="componentOptionValue")
    component_option_id: Optional[str] = Field(alias="componentOptionId", default=None)


class ProductBundleConsolidatedOptionInput(BaseModel):
    option_name: str = Field(alias="optionName")
    option_selections: list["ProductBundleConsolidatedOptionSelectionInput"] = Field(
        alias="optionSelections"
    )


class ProductBundleConsolidatedOptionSelectionInput(BaseModel):
    option_value: str = Field(alias="optionValue")
    components: list["ProductBundleConsolidatedOptionComponentInput"]


class ProductBundleCreateInput(BaseModel):
    title: str
    consolidated_options: Optional[list["ProductBundleConsolidatedOptionInput"]] = (
        Field(alias="consolidatedOptions", default=None)
    )
...
class ReturnLineItemInput(BaseModel):
    quantity: int
    return_reason_definition_id: Optional[str] = Field(
        alias="returnReasonDefinitionId", default=None
    )
...
class SellingPlanAnchorInput(BaseModel):
    type_: Optional[SellingPlanAnchorType] = Field(alias="type", default=None)
...
class SellingPlanCheckoutChargeInput(BaseModel):
    type_: Optional[SellingPlanCheckoutChargeType] = Field(alias="type", default=None)
...
class ShopPolicyInput(BaseModel):
    type_: ShopPolicyType = Field(alias="type")
    body: str
...
DiscountContextInput.model_rebuild()
...
ProductBundleConsolidatedOptionInput.model_rebuild()
ProductBundleConsolidatedOptionSelectionInput.model_rebuild()
