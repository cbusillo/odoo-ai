...
class TestShipping(IntegrationTestCase):
    ...
    def test_shipping_fields_default_values(self) -> None:
        ...
        self.assertFalse(order.external_reference.id)
        self.assertFalse(order.external.ebay.order.id)
    ...
    def test_source_platform_values(self) -> None:
        ...
        order.external_reference.id = "123456789"
        ...
        ebay_order.external.ebay.order.id = "12-34567-89012"

        self.assertEqual(ebay_order.source_platform, "ebay")
        self.assertEqual(ebay_order.external.ebay.order.id, "12-34567-89012")
        self.assertFalse(ebay_order.external_reference.id)
    ...
    def test_copy_method(self) -> None:
        ...
        order.external_reference.id = "123"
        order.external.ebay.order.id = "EBAY456"
        ...
        self.assertFalse(copied_order.external_reference.id)
        self.assertFalse(copied_order.external.ebay.order.id)
