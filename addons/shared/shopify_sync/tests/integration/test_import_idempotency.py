...
class TestImportIdempotencyUnit(IntegrationTestCase):
    ...
    def test_order_import_creates_new_order(self) -> None:
        ...
        order_data = create_shopify_order_response(
            ...
            name="#NEW-001",
            customer=create_shopify_customer_response(gid="gid://shopify/Customer/2001", email="customer1@test.com"),
            line_items=[
                create_shopify_order_line_item_response(
        ...
        orders = self.env["sale.order"].search_by_bound_external_id("1001")
    ...
    def test_order_import_existing_unchanged_returns_false(self) -> None:
        ...
        order_data = create_shopify_order_response(
            ...
            name="#EXIST-001",
            customer=create_shopify_customer_response(gid="gid://shopify/Customer/2002", email="customer2@test.com"),
            line_items=[
                create_shopify_order_line_item_response(
                    sku=self.test_product.default_code,
                    variant_id="987654321",
        ...
        orders = self.env["sale.order"].search_by_bound_external_id("1002")
        self.assertEqual(len(orders), 1)
    ...
    def test_order_import_with_updates_returns_true(self) -> None:
        ...
        order_data = create_shopify_order_response(
            ...
            name="#UPDATE-001",
            customer=create_shopify_customer_response(gid="gid://shopify/Customer/2003", email="customer3@test.com"),
            line_items=[
                create_shopify_order_line_item_response(
                    sku=self.test_product.default_code,
                    variant_id="987654321",
        ...
        orders = self.env["sale.order"].search_by_bound_external_id("1003")
        self.assertEqual(len(orders), 1)
    ...
    def test_customer_import_creates_new_customer(self) -> None:
        ...
        customers = self.env["res.partner"].search_by_external_id("shopify", "3001", resource="customer")
    ...
    def test_customer_import_existing_unchanged_returns_false(self) -> None:
        ...
        customers = self.env["res.partner"].search_by_external_id(
            "shopify",
            "3002",
            resource="customer",
        )
    ...
    def test_product_import_creates_new_product(self) -> None:
        ...
        product_data = create_shopify_product_response(
            gid="gid://shopify/Product/5001",
            title="New Product",
            vendor="Test Manufacturer",
            product_type="Motors",
            variants=[
                create_shopify_variant_response(
                    gid="gid://shopify/ProductVariant/6001",
                    sku="NEW001",
                    price="149.99",
                )
            ],
        ...
        products = self.env["product.product"].search_by_external_id(
            "shopify",
            "5001",
            resource="product",
        )
    ...
    def test_product_import_uses_first_variant(self) -> None:
        ...
        product_data = create_shopify_product_response(
            gid="gid://shopify/Product/5003",
            title="Multi Variant Product",
            vendor="Test Manufacturer",
            product_type="Motors",
            variants=[
                create_shopify_variant_response(
                    gid="gid://shopify/ProductVariant/6003",
                    sku="MULTI001",
                ),
                create_shopify_variant_response(
                    gid="gid://shopify/ProductVariant/6004",
                    sku="MULTI002",
                    price="149.99",
                ),
            ],
        ...
        variants = self.env["product.product"].search_by_external_id(
            "shopify",
            "5003",
            resource="product",
        )
        ...
        self.assertEqual(variants[0].get_external_system_id("shopify", "variant"), "6003")
