...
- Added a base pre-migration hook that strips legacy `sel_groups_*`,
  `in_group_*`, and `user_group_warning` fields from the legacy user-group
  views before the 19.0 upgrade.
