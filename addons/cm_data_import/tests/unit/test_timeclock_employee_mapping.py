...
def _punch_row(*, record_id: int, user_id: int | None, compnum: int | None) -> CmDataTimeclockPunch:
    return CmDataTimeclockPunch(
        ...
        user_id=user_id,
        check_type=None,
        check_time=datetime(2026, 3, 14, 9, 0, 0),
        sensor_id=None,
        checked=None,
        reason=None,
        work_type=None,
...
class TestTimeclockEmployeeMapping(UnitTestCase):
    ...
    def test_collect_timeclock_placeholder_specs_groups_unresolved_compnums(self) -> None:
        placeholder_specs = self.importer._collect_timeclock_placeholder_specs(
            [
                ...
                CmDataTimeclockPunch(**{**_punch_row(record_id=2, user_id=50, compnum=42).__dict__, "check_time": datetime(2026, 3, 15, 9, 0, 0)}),
        ...
        self.assertEqual(placeholder_specs[42]["first_seen"], datetime(2026, 3, 14, 9, 0, 0))
        self.assertEqual(placeholder_specs[42]["last_seen"], datetime(2026, 3, 15, 9, 0, 0))
    ...
    def test_ensure_timeclock_placeholder_employees_registers_compnum_alias(self) -> None:
        ...
        sync_started_at = datetime(2026, 3, 14, 12, 0, 0)
