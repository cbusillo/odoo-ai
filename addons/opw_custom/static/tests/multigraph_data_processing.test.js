...
describe("@opw_custom MultigraphModel Data Processing", () => {
    let model
    let mockOrm
                ...
                groups: [
                    {
                        ...
                        date: "2024-01-01",
                        "revenue:sum": 10000,
                        "cost:sum": null, // Null value
                        "quantity:sum": undefined, // Undefined value
                    },
                    {
                        __domain: [],
                        date: "2024-02-01",
                        "revenue:sum": 0, // Zero value
                        "cost:sum": 5000,
                        "quantity:sum": 100,
                    },
                ],
        ...
        mockOrm = {
            webReadGroup: async () => ({
                groups: [{
                    ...
                    "m4:sum": 400,
                    "m5:sum": 500,
                    "m6:sum": 600, // More than 5 measures to test color cycling
                }],
            }),
        }
    ...
    test("uses context groupbys when searchParams groupBy is empty", async () => {
        mockOrm = {
            webReadGroup: async (model, domain, groupBy) => {
