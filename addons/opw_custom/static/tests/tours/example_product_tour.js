...
/**
 * Example tour test for OPW Custom module
 * This tour demonstrates navigating to the OPW Custom product list and performing basic actions
 */
registry.category("web_tour.tours").add("example_product_tour", {
    ...
    url: "/web#action=opw_custom.action_product_template_list_edit",
    steps: () => [
        {
            ...
            run() {
                ...
                if (!bc || !/Product/i.test(bc.textContent || "")) {
                    ...
                    try {
                        ...
                        actionService?.doAction?.("opw_custom.action_product_template_list_edit")
                    } catch (e) {
                    }
                }
            },
