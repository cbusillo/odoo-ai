...
@main.command("compatibility-dokploy-worker", hidden=True)
@click.option("--context", "context_name", required=True)
@click.option(
    "--instance",
    "instance_name",
...
@click.option("--dry-run", is_flag=True, default=False)
@click.option("--no-cache", is_flag=True, default=False)
@click.option("--skip-gate", is_flag=True, default=False)
@click.option("--allow-dirty", is_flag=True, default=False)
...
@click.option("--branch-sync-update-required/--no-branch-sync-update-required", default=False)
@click.option("--branch-sync-applied/--no-branch-sync-applied", default=False)
@click.option("--resolved-target-type", type=click.Choice(("compose", "application")), required=True)
@click.option("--resolved-target-id", required=True)
@click.option("--resolved-target-name", required=True)
def compatibility_dokploy_worker(
    context_name: str,
    instance_name: str,
    env_file: Path | None,
    wait: bool,
